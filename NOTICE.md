# NOTICE — third-party homages

A few of the sprite-trail **transition** plugins in this repository are
**unofficial fan homages** to well-known franchises. The character names,
designs, and any bundled sprite artwork they reference are the property of their
respective owners. They are used here in good faith as **non-commercial homage**
...
implied. If you reuse or redistribute this repository, you are responsible for
your own use of these third-party references.

The rest of the plugins in this repository (e.g. `pool`, `baseball`, `crypto`,
`calendar`, `rss`, `weather`) are original works with no such third-party
dependency.
